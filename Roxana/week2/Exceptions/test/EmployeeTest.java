...
public class EmployeeTest {
	 ...
	 * @param dao
	 *            Employee which support CURD modifications.
	 * 
	 * @return Return false when the user want to quit.
	 * @throws IOException
	 */
	...
	/**
	 * Returns the informations which was read;
	 * 
	 * @param in
	 *            Input source to use for data entry
	...
	/**
	 * Read the informations and return a new Employee object
	 * 
	 * @param in
	 *            Input source to use for data entry
	 * @param empDefaults
	...
	/**
	 * Read the informations and return a new Employee
	 * @param in
	 *            Input source to use for data entry
	 * @param empDefaults
	 * @param newEmployee
		...
		if (newEmployee) {
			do {
				...
				try {
					id = new Integer(in.readLine().trim());
					if (id < 0) {
						throw new NumberFormatException("Please retry with a valid positive integer id");
					}
