...
/**
 * Class to test the functionality of the Cmployee class
 */
...
public class EmployeeTest {
    ...
    /**
     * Menu to select different actions to perform.
     * @param in Buffer to read
     * @param dao object that is used to manipulate the employees
     * @return true or false to determine if the program is finised or not
     * @throws IOException
     */
    ...
    /**
     * read an employee form the buffer
     * @param in and
